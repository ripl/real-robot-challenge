...
import numpy as np
import time
from code.utils import Transform, filter_none_elements, repeat
...
class WholeBodyPlanner:
    ...
    def get_fingers_collision_fn(self):
        ...
        """
        from code.grasping import CollisionConfig
    ...
    def plan(self, pos, quat, goal_pos, goal_quat, retry_grasp=10,
